...
} from './prescription-dialog/laboratory-rx-dialog/laboratory-rx-dialog.component';
import {
  NutritionRxResult,
  NutritionRxDialogComponent
} from './prescription-dialog/nutrition-rx-dialog/nutrition-rx-dialog.component';
import {
  OrderRxResult,
  OrderRxDialogComponent
} from './prescription-dialog/order-rx-dialog/order-rx-dialog.component';
import {
  PharmacyRxResult,
